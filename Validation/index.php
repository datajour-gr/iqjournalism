...
//     $filename = 'emotions/data_' . $_GET['arthro'] . '_validate.json';
...
//     $file_name  = 'data_' . $_GET['arthro'] . '.json';
//     $json_data = file_get_contents('/home/whiteson/uoa/src/' . $file_name);
//     //if file exists check if validate file exists
//     $validation_file =  'data_' . $_GET['arthro'] . '_validate.json';
...
<body>
    ...
    <div class="container-fluid full-height   pt-3">
        <div class="row pt-4">
            <div class="col-md-12">
                <?php if (isset($data) && $svg && $validation_data) : ?>
                ...
                <?php else : ?>
                    ...
                    <a href="emotions.php?arthro=0"><b>Emotions Emolex</b> overview</a><br>
                    <a href="vad.php?arthro=0"><b>Vad</b> overview</a><br>
                    <a href="ail.php?arthro=0"><b>Ail</b> overview</a> -->
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $('.correct').on('click', function(event) {
            ...
            $.ajax({
                url: "?arthro=<?php echo $_GET['arthro']; ?>",
                method: "POST",
                data: {
                    text: row_text,
                    label: 'correct',
